...
- -item detection (work in progress) -updated some items 

- 🔒 No enrollment, no storage, — 100% safe to demo or showcase
- 💻 Built with Python, Flask, and OpenCV
- amin panel -- updated - changed design
- 2fa verification -- updated - added more options
- sms alerts -- updated -- updated redone 
- User roles - added more rules and authorites with roles -- added more authority options
- updated css- re did color scheme updates 
-updated home page - changed layout updated 
...
- SMS Alert for faces shown in camera is available in non showcase versions.  - updated -updated -- changed alert noise 
